...
//! This module provides a function, `parse()`, for building an
//! Abstract Syntax Tree out of a flat sequence of `Token`s,
//! itself generated by the `lexer` module. The module depends
